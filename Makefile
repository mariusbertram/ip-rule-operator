...
# ghcr.io/<user>/ip-rule-operator-bundle:$VERSION and ghcr.io/<user>/ip-rule-operator-catalog:$VERSION.
...
.PHONY: agent-build
agent-build: generate fmt vet ## Build the iprule-agent binary
