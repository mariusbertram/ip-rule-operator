...
var _ = Describe("IPRule Controller", func() {
	Context("When reconciling a resource", func() {
		...
		iprule := &apiv1alpha1.IPRule{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind IPRule")
			err := k8sClient.Get(ctx, typeNamespacedName, iprule)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance IPRule")
